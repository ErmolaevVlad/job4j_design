...
public class LongestUniqueSubstringTest {
    ...
    @Test
    public void whenFirstSubstringIsGreaterThanTheOthers() {
        String str = "abcdefgtfkm";
        assertThat(LongestUniqueSubstring.longestUniqueSubstring(str)).isEqualTo("abcdefgt");
    }
}
