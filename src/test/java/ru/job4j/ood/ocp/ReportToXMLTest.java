...
class ReportToXMLTest {
    ...
    @Test
    void whenTwoEmployeesThenReportWithTwoEmployees() throws JAXBException {
        ...
        store.add(employee);
        store.add(employee1);
        Report report = new ReportToXML(store, parser);
        String expect = """
    ...
    @Test
    void whenOneEmployeeThenReportWithOneEmployee() throws JAXBException {
        Store store = new MemoryStore();
        DateTimeParser<Calendar> parser = new ReportDateTimeParser();
        Employee employee = new Employee("John Doe",
                new GregorianCalendar(2023, Calendar.JUNE, 8, 17, 41),
